...
from qube.src.api.hellotestcontroller import HelloTestController
from qube.src.api.hellotestcontroller import HelloTestItemController
from qube.src.api.versioncontroller import HelloTestItemVersionController
...
api.add_resource(HelloTestItemVersionController, '/v1/hellotest/version')
api.add_resource(HelloTestController, '/v1/hellotest')
api.add_resource(HelloTestItemController, '/v1/hellotest/<string:entity_id>')
