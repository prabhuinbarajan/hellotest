...
HELLO_VERSION = "/v1/hellotest/version"
...
class TestHelloTestVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_hellotest_default_version(self, *args, **kwargs):
    ...
    def test_hellotest_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
